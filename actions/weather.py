...
class ActionGetWeather(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        Final_url = base_url + "app_id=" + app_id + "&app_code=" + app_key + "&product=observation&name=" + gpe
        ...
        if (len(weather_data) > 2):
            ...
            response = """ It is {} in {} at this moment. The temperature is {} degree and the wind speed is {} m/s. """. format(desc, gpe, current_temperature, wind)
